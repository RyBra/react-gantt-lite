...
var GanttChart = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("fx-gantt w-full", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "fx-gantt-toolbar", style: { marginBottom: 12, display: "flex", gap: 8, alignItems: "center", justifyContent: "space-between", color: theme?.textColor }, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "fx-gantt-card", style: { border: "1px solid #e5e7eb", borderRadius: 8, overflow: "hidden", background: theme?.cardBg ?? "#ffffff", color: theme?.textColor }, children: /* @__PURE__ */ jsxs("div", { style: { display: "flex" }, children: [
      /* @__PURE__ */ jsxs("div", { className: cn("fx-gantt-sidebar"), style: { width: 320, flexShrink: 0, background: theme?.sidebarBg ?? "#fafafa" }, children: [
        /* @__PURE__ */ jsx("div", { style: { height: 49, display: "flex", alignItems: "center", padding: "0 12px", borderBottom: "1px solid #e5e7eb", background: theme?.headerBg ?? "#fafafa", fontWeight: 500, boxSizing: "border-box" }, children: "\u041E\u043F\u0435\u0440\u0430\u0446\u0438\u0438" }),
        Object.entries(groupedTasks).map(([groupName, groupTasks]) => /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { style: { height: 40, display: "flex", alignItems: "center", padding: "0 10px", borderBottom: `1px solid ${theme?.gridLine ?? "#f1f5f9"}`, background: theme?.headerBg ?? (theme?.sidebarBg ?? "#fafafa"), boxSizing: "border-box" }, children: renderGroupHeader ? renderGroupHeader(groupName, groupTasks) : /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsx("span", { style: { fontWeight: 500 }, children: groupName }),
            /* @__PURE__ */ jsx("span", { style: { fontSize: 12, background: theme?.gridLine ?? "#f3f4f6", borderRadius: 8, padding: "2px 6px" }, children: groupTasks.length })
          ] }) }),
          groupTasks.map((task) => /* @__PURE__ */ jsxs("div", { style: { height: rowHeight, display: "flex", flexDirection: "column", justifyContent: "center", gap: 4, padding: "0 10px", borderBottom: "1px solid #f1f5f9", boxSizing: "border-box" }, children: [
            /* @__PURE__ */ jsx("div", { style: { fontSize: 14, fontWeight: 500, color: theme?.textColor ?? "#111827", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: task.name || "\u0411\u0435\u0437 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044F" }),
            /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8, color: theme?.textColor ?? "#6b7280", opacity: 0.75, fontSize: 12 }, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "fx-gantt-timeline", style: { flex: 1, overflow: "auto" }, children: /* @__PURE__ */ jsxs("div", { style: { minWidth: `${timeScale.length * columnWidth}px`, position: "relative" }, children: [
        /* @__PURE__ */ jsx("div", { style: { position: "sticky", top: 0, zIndex: 1, background: theme?.headerBg ?? "#fff", borderBottom: "1px solid #e5e7eb", color: theme?.textColor }, children: /* @__PURE__ */ jsx("div", { style: { display: "flex", height: 48 }, children: timeScale.map((date, index) => {
          const isToday = date.toDateString() === (/* @__PURE__ */ new Date()).toDateString();
          return /* @__PURE__ */ jsx("div", { style: { minWidth: columnWidth, width: columnWidth, borderRight: `1px solid ${theme?.gridLine ?? "#f1f5f9"}`, padding: 8, textAlign: "center", fontSize: 12, fontWeight: 500, background: isToday ? theme?.headerTodayBg ?? "#eff6ff" : void 0, color: isToday ? theme?.headerTodayText ?? "#1d4ed8" : void 0, boxSizing: "border-box" }, children: renderTimeCell ? renderTimeCell(date, index, isToday) : /* @__PURE__ */ jsx("div", { children: dateFormatter ? dateFormatter(date, view.timeScale.unit) : formatHeader(date, view.timeScale.unit, locale, { weekNumbering, weekHeaderMode }) }) }, index);
        }) }) }),
        /* @__PURE__ */ jsx("div", { style: { position: "relative" }, children: Object.entries(groupedTasks).map(([groupName, groupTasks]) => /* @__PURE__ */ jsxs("div", { children: [
          ...
          groupTasks.map((task) => {
            ...
            return /* @__PURE__ */ jsxs("div", { style: { position: "relative", height: rowHeight, borderBottom: "1px solid #f1f5f9", boxSizing: "border-box" }, children: [
              timeScale.map((_, index) => /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: 0, bottom: 0, left: index * columnWidth, width: 0, borderRight: `1px solid ${theme?.gridLine ?? "#f1f5f9"}` } }, index)),
        ...
        showTodayLine && /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: 48, bottom: 0, pointerEvents: "none" }, children: timeScale.map((date, index) => {
          ...
          return /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: 0, bottom: 0, left: index * columnWidth, width: 2, background: theme?.todayLine ?? "#3b82f6" } }, "today-line");
        }) })
      ] }) })
    ] }) })
  ] });
